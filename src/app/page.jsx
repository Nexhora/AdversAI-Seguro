        ...
        <section id="herramientas" className="py-20 md:py-32">
             <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    {[
                        { title: 'Generador de Anuncios', img: 'https://placehold.co/400x500.png', hint: 'ad generator' },
                        { title: 'Generador de Landing Pages', img: 'https://placehold.co/400x500.png', hint: 'landing page' },
                        { title: 'Laboratorio IA', img: 'https://placehold.co/400x500.png', hint: 'ai lab' },
            ...
            <div className="container mx-auto px-4 md:px-6">
                 ...
                 <div className="mt-16 grid md:grid-cols-3 gap-8">
                    {[
                        ...
                        { name: 'Laura Fernandez', role: 'Consultora de Marketing', text: '"Puedo entregar a mis clientes estrategias completas, con anuncios y landings, en días en lugar de semanas. Ha cambiado mi negocio por completo."', img: 'https://placehold.co/100x100.png', hint: 'portrait professional' },
                        { name: 'Javier Rios', role: 'Emprendedor Solitario', text: '"No soy diseñador ni copywriter. AdVerseAI es mi equipo de marketing completo. Finalmente puedo competir con los grandes."', img: 'https://placehold.co/100x100.png', hint: 'portrait professional' },
                    ].map(testimonial => (
                     ...
                     {[
                        ...
                        <details key={faq.q} className="bg-gray-800/50 p-4 rounded-lg border border-gray-700 cursor-pointer group">
                           <summary className="font-semibold flex items-center justify-between">
                                {faq.q}
                                <svg className="w-5 h-5 ml-4 transform transition-transform duration-300 group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
                           </summary>
