        ...
        <section id="herramientas" className="py-20 md:py-32">
             <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    {[
                        { title: 'Generador de Anuncios', img: 'https://placehold.co/400x500.png', hint: 'abstract 3d' },
                        { title: 'Generador de Landing Pages', img: 'https://placehold.co/400x500.png', hint: 'abstract gradient' },
                        { title: 'Laboratorio IA', img: 'https://placehold.co/400x500.png', hint: 'futuristic technology' },
                        { title: 'Creador de Mockups', img: 'https://placehold.co/400x500.png', hint: 'minimalist wireframe' },
                        { title: 'Creador de eBooks', img: 'https://placehold.co/400x500.png', hint: 'book cover' },
                    ].map(tool => (
        ...
        <section className="py-20 bg-gray-900/50">
            <div className="container mx-auto px-4 md:px-6">
                 ...
                 <div className="mt-16 grid md:grid-cols-3 gap-8">
                    {[
                        { name: 'Carlos Gomez', role: 'Dueño de eCommerce', text: '"Desde que uso Nexhora, mi CPA ha bajado un 40%. La capacidad de testear ángulos tan rápido no tiene precio."', img: 'https://placehold.co/100x100.png' },
                        { name: 'Laura Fernandez', role: 'Consultora de Marketing', text: '"Puedo entregar a mis clientes estrategias completas, con anuncios y landings, en días en lugar de semanas. Ha cambiado mi negocio por completo."', img: 'https://placehold.co/100x100.png' },
                        { name: 'Javier Rios', role: 'Emprendedor Solitario', text: '"No soy diseñador ni copywriter. Nexhora es mi equipo de marketing completo. Finalmente puedo competir con los grandes."', img: 'https://placehold.co/100x100.png' },
                    ].map(testimonial => (
                         <div key={testimonial.name} className="bg-gray-800 p-6 rounded-lg border border-gray-700">
                             <div className="flex items-center gap-4 mb-4">
                                <img src={testimonial.img} alt={testimonial.name} className="w-14 h-14 rounded-full object-cover border-2 border-orange-500" data-ai-hint="portrait professional" />
                                <div>
