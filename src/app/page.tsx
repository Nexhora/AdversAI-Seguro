        ...
        <section id="herramientas" className="py-20 md:py-32">
             <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    {[
                        { title: 'Generador de Anuncios', img: 'https://placehold.co/400x500/111827/FF9800?text=Ad+Gen' },
                        { title: 'Generador de Landing Pages', img: 'https://placehold.co/400x500/111827/FF9800?text=Landing+AI' },
                        { title: 'Laboratorio IA', img: 'https://placehold.co/400x500/111827/FF9800?text=Builder' },
                        { title: 'Creador de Mockups', img: 'https://placehold.co/400x500/111827/FF9800?text=Mockups' },
                        { title: 'Creador de eBooks', img: 'https://placehold.co/400x500/111827/FF9800?text=eBooks' },
                    ].map(tool => (
        ...
        <section className="py-20 bg-gray-900/50">
            <div className="container mx-auto px-4 md:px-6">
                 ...
                 <div className="mt-16 grid md:grid-cols-3 gap-8">
                    {[
                        { name: 'Carlos Gomez', role: 'Dueño de eCommerce', text: '"Desde que uso Nexhora, mi CPA ha bajado un 40%. La capacidad de testear ángulos tan rápido no tiene precio."', img: 'https://placehold.co/100x100/1a202c/ffffff?text=CG' },
                        ...
                        { name: 'Javier Rios', role: 'Emprendedor Solitario', text: '"No soy diseñador ni copywriter. Nexhora es mi equipo de marketing completo. Finalmente puedo competir con los grandes."', img: 'https://placehold.co/100x100/1a202c/ffffff?text=JR' },
                    ].map(testimonial => (
